defmodule MaxoAdapt.Impl.GetCompiledTest do
  use ExUnit.Case
  ...
  test "does not allow switching adapters" do
    # Check default
    ...
    Enum.each([Red, Green, Blue], fn c ->
      assert_raise RuntimeError, fn -> Color.configure(c) end
    end)
  end
    ...
    Code.compile_quoted(
      quote do
        defmodule unquote(mod) do
          use MaxoAdapt, unquote([{:mode, :get_compiled} | opts])
